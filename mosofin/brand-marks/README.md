...
Mosofin ships a bounded catalogue of 107 commonly used brands for architecture,
...
`node bin/mosofin.mjs brands capture <url> --json`, then author the returned
...
and intended referential use before adding or updating a mark. Mosofin does not
