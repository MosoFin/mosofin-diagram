...
// export and embedding. The fixed IDs are deterministic because an Mosofin
...
export function svgAccessibleText(meta, kind) {
  ...
  return `        <title id="mosofin-diagram-title">${esc(meta.title)}</title>\n        <desc id="mosofin-diagram-description">${esc(description)}</desc>`;
}
...
// canonical SVG is embedded inline outside the full Mosofin viewer.
