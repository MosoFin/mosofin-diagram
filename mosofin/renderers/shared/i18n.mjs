...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.architecture': ['An architecture diagram generated by Mosofin.', '由 Mosofin 生成的架构图。'],
  'diagram.description.workflow': ['A workflow diagram generated by Mosofin.', '由 Mosofin 生成的工作流图。'],
  'diagram.description.sequence': ['A sequence diagram generated by Mosofin.', '由 Mosofin 生成的时序图。'],
  'diagram.description.dataflow': ['A data-flow diagram generated by Mosofin.', '由 Mosofin 生成的数据流图。'],
  'diagram.description.lifecycle': ['A lifecycle diagram generated by Mosofin.', '由 Mosofin 生成的生命周期图。'],
  ...
  'legend.architecture.frontend': ['Commerce', '销售前台'],
  'legend.architecture.backend': ['Payments', '支付'],
  'legend.architecture.database': ['Ledger', '账本'],
  'legend.architecture.cloud': ['Bank', '银行'],
  'legend.architecture.security': ['Control', '控制'],
  'legend.architecture.messagebus': ['Sync', '同步'],
  'legend.architecture.external': ['Counterparty', '往来方'],
  'legend.workflow.frontend': ['Commerce', '销售前台'],
  'legend.workflow.backend': ['Payments', '支付'],
  'legend.workflow.security': ['Control', '控制'],
  'legend.workflow.messagebus': ['Bank', '银行'],
  'legend.workflow.database': ['Books', '账本'],
  'legend.workflow.cloud': ['Platform', '平台'],
  'legend.workflow.external': ['Counterparty', '往来方'],
  'legend.sequence.emphasis': ['charge / order', '扣款 / 订单'],
  'legend.sequence.return': ['settlement', '结算'],
  'legend.sequence.security': ['control', '控制'],
  'legend.sequence.dashed': ['bank feed', '银行流水'],
  'legend.sequence.default': ['step', '步骤'],
  'legend.dataflow.emphasis': ['money', '资金'],
  'legend.dataflow.security': ['contra / deduction', '冲减 / 扣项'],
  'legend.dataflow.dashed': ['timing difference', '时间性差异'],
  'legend.dataflow.database': ['account', '账户'],
  'legend.dataflow.default': ['sync', '同步'],
  'legend.lifecycle.start': ['opened', '发起'],
  'legend.lifecycle.active': ['in flight', '处理中'],
  'legend.lifecycle.waiting': ['awaiting', '等待中'],
  'legend.lifecycle.decision': ['tie-out', '核对'],
  'legend.lifecycle.success': ['booked', '已入账'],
  'legend.lifecycle.failure': ['break / exit', '差异 / 终止'],
  'legend.lifecycle.neutral': ['note', '备注'],
  'legend.lifecycle.external': ['counterparty', '往来方'],

  'viewer.kind.frontend': ['Commerce', '销售前台'],
  'viewer.kind.backend': ['Payments', '支付'],
  'viewer.kind.database': ['Ledger', '账本'],
  'viewer.kind.cloud': ['Bank', '银行'],
  'viewer.kind.security': ['Control', '控制'],
  'viewer.kind.messagebus': ['Sync', '同步'],
  'viewer.kind.external': ['Counterparty', '往来方'],
  'viewer.kind.neutral': ['Note', '备注'],
  'viewer.kind.node': ['System', '系统'],
  'viewer.kind.start': ['Opened', '发起'],
  'viewer.kind.active': ['In flight', '处理中'],
  'viewer.kind.waiting': ['Awaiting', '等待中'],
  'viewer.kind.decision': ['Tie-out', '核对'],
  'viewer.kind.success': ['Booked', '已入账'],
  'viewer.kind.failure': ['Break', '差异'],
  ...
  'viewer.nodestyle.title': ['Switch node style (box or logo)', '切换节点样式（方框或标志）'],
  'viewer.nodestyle.box': ['Box', '方框'],
  'viewer.nodestyle.logo': ['Logo', '标志'],
  ...
  'viewer.preset.badge.editorialPlate': ['MOSOFIN / PLATE 04', 'MOSOFIN / 图版 04'],
  ...
  'viewer.export.card.routeBadge': ['MOSOFIN · ROUTE · {hops}', 'MOSOFIN · 路径 · {hops}'],
  'viewer.export.card.reachBadge': ['MOSOFIN · {direction} REACH', 'MOSOFIN · {direction}可达范围'],
  'viewer.export.card.defaultBadge': ['MOSOFIN · {preset} · {theme}', 'MOSOFIN · {preset} · {theme}'],
  ...
  'viewer.lens.title': ['Compare business roles', '比较业务角色'],
  'viewer.lens.close': ['Close semantic lens', '关闭语义透镜'],
  'viewer.lens.instruction': ['Choose up to two roles. One reveals everything it touches; two compare only the direct links between them.', '最多选择两种角色。选择一种可显示它触及的一切；选择两种只比较两者之间的直接关系。'],
  'viewer.lens.kinds': ['Business roles', '业务角色'],
  'viewer.lens.choose': ['Choose a role to inspect its systems and everything they touch.', '选择一种角色以检查相关系统及其所有连接。'],
