...
test('applyTemplate preserves dollar sequences in titles', () => {
  const template = `<html lang="en" data-theme="dark" data-preset="[VISUAL PRESET]" data-node-style="[NODE STYLE]">
<title>[PROJECT NAME] Architecture Diagram</title>
<h1>[PROJECT NAME] Architecture</h1>
<p class="subtitle">[Subtitle description]</p>
<!-- MOSOFIN:GUIDED_VIEWS_DATA -->
      <!-- MOSOFIN:SVG_SLOT_START --><svg></svg>      <!-- MOSOFIN:SVG_SLOT_END -->
    <!-- MOSOFIN:CARDS_SLOT_START --><div></div>    <!-- MOSOFIN:CARDS_SLOT_END -->`;
...
test('applyTemplate requires the new evidence slot only when evidence is present', () => {
  const legacyTemplate = `<html lang="en" data-theme="dark" data-preset="[VISUAL PRESET]" data-node-style="[NODE STYLE]">
<title>[PROJECT NAME] Architecture Diagram</title>
<h1>[PROJECT NAME] Architecture</h1>
<p class="subtitle">[Subtitle description]</p>
<!-- MOSOFIN:GUIDED_VIEWS_DATA -->
