...
test('repository language metadata separates generated artifacts from implementation source', () => {
  for (const generatedPath of [
    'mosofin/examples/web-app-rendered.html',
    'examples/web-app.html',
    'docs/gallery.html',
    'docs/gallery/artifacts/northline-money-map.architecture.html',
    'docs/guide.html',
    'docs/start.html',
    'mosofin/renderers/shared/generated-brand-marks.mjs',
    'mosofin/renderers/shared/generated-validators.mjs',
  ]) {
    assert.equal(
